...
class DatafriendsBaseEngineSpec(BaseEngineSpec):
    """Abstract class for Postgres 'like' databases"""

    engine = ""
    engine_name = "Datafriends"
...
class DatafriendsBaseEngineSpec(BasicParametersMixin, DatafriendsBaseEngineSpec):
    engine = "datafriends"
    engine_aliases = {"Datafriends"}
